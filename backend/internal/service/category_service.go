...
// GetByID 根据 ID 获取详情
func (s *categoryServiceImpl) GetByID(ctx context.Context, id uint32) (*model.Categories, error) {
...
// Delete 删除分类
func (s *categoryServiceImpl) Delete(ctx context.Context, id uint32) error {
	// 1. 校验是否存在
